...
primitives in `pyrox_gp._basis._rff` (`draw_rff_cosine_basis` /
...
Inducing-feature priors (`pyrox_gp.FourierInducingFeatures`,
`pyrox_gp.SphericalHarmonicInducingFeatures`,
`pyrox_gp.LaplacianInducingFeatures`) are not yet covered —
...
from pyrox_gp._guides import WhitenedGuide
...
def _frozen_kernel_fn(
    ...
    `pyrox_gp._basis._rff.draw_rff_cosine_basis`.
    """
