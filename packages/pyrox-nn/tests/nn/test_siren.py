"""Tests for pyrox_nn SIREN layers.

Covers :class:`pyrox_nn.SirenDense`, :class:`pyrox_nn.SIREN`, and
:class:`pyrox_nn.BayesianSIREN`.
"""
...
from pyrox_nn import SIREN, BayesianSIREN, SirenDense
